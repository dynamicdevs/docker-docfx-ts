...
WORKDIR /docfx
CMD [ "/bin/bash", "-c", "typedoc --json api.json /src --module commonjs --includeDeclarations --ignoreCompilerErrors --excludeExternals && type2docfx api.json yml && docfx build" ]